try {
    ...
    $.ajax({url: 'assets/live2d.js?v=1.0.5',dataType:"script", cache: true, async: false});
    /* 可直接修改部分参数 */
    ...
    //看板娘样式设置
    live2d_settings['waifuSize'] = '420x375'; // 看板娘大小，例如 '280x250', '600x535'
    live2d_settings['waifuTipsSize'] = '375x105'; // 提示框大小，例如 '250x70', '570x150'
    live2d_settings['waifuFontSize'] = '25px'; // 提示框字体，例如 '12px', '30px'
    live2d_settings['waifuToolFont'] = '40px'; // 工具栏字体，例如 '14px', '36px'
    live2d_settings['waifuToolLine'] = '80px'; // 工具栏行高，例如 '20px', '36px'
    live2d_settings['waifuToolTop'] = '-100px' // 工具栏顶部边距，例如 '0px', '-60px'
    live2d_settings['waifuMinWidth'] = '1200px'; // 面页小于 指定宽度 隐藏看板娘，例如 'disable'(禁用), '768px'
