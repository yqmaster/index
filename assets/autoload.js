try {
    ...
    //看板娘样式设置
    live2d_settings['waifuSize'] = '660x535'; // 看板娘大小，例如 '280x250', '600x535'
    live2d_settings['waifuTipsSize'] = '570x150'; // 提示框大小，例如 '250x70', '570x150'
    live2d_settings['waifuFontSize'] = '30px'; // 提示框字体，例如 '12px', '30px'
    live2d_settings['waifuToolFont'] = '60px'; // 工具栏字体，例如 '14px', '36px'
