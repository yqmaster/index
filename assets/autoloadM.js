try {
    ...
    //看板娘样式设置
    live2d_settings['waifuSize'] = '500x600'; // 看板娘大小，例如 '280x250', '600x535'
    live2d_settings['waifuTipsSize'] = '450x150'; // 提示框大小，例如 '250x70', '570x150'
    live2d_settings['waifuFontSize'] = '32px'; // 提示框字体，例如 '12px', '30px'
